...
typedef byte (*Z80DataIn) 	(int param, ushort address, void* user_data);


/** Function type to emulate data write. */
typedef void (*Z80DataOut)	(int param, ushort address, byte data, void* user_data);
...
typedef struct
{
    ...
    /* Arbitrary user data to receive through callbacks */
    void* user_data;
